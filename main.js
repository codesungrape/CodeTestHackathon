...
- If the function is missing an input, then it should THROW an error message "There is no input to check!"
- It doesn't matter if the letters are lower or uppercase, ALL vowels need to be removed.
